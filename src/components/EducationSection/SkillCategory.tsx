          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {[
                ...
                {name: "Django", level: 97 },
                { name: "React.js", level: 90 },
                { name: "Node.js", level: 90 },
                { name: "REST framework", level: 90 },
                { name: "JavaScript", level: 92 },
                { name: "Database ( MySQL,MongoDB,PostgreSQL)", level: 95 },
                { name: "Developer Tools  ( VS Code, PyCharm, Figma, Git/GitHub, Cursor.AI )", level: 98 },
